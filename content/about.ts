export const about = {
  name: "Shivansh Singh",
  role: "Robotics & low-latency systems engineer",
  blurb:
    "I build systems where correctness and latency actually matter — autonomous robots, lock-free " +
    "trading infrastructure, and the tooling around them. Modern C++ by default, whatever else the " +
    "problem needs.",
  athletics:
