...
export const projects: Project[] = [
  ...
  },
  {
    ...
    media: [
      {
        type: "image",
        src: "/media/xplane11-sim-bridge/cockpit.jpg",
        alt: "X-Plane 11 running a simulated Cessna — the flight simulator used as the HITL/SITL testbed, with its native flight-data overlay",
      },
    ],
  },
  {
